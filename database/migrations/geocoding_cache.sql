-- RotaFácil - Cache Inteligente de Geocodificação
...
CREATE INDEX IF NOT EXISTS idx_geocoding_cache_city_state ON geocoding_cache(city, state);
CREATE INDEX IF NOT EXISTS idx_geocoding_cache_cep ON geocoding_cache(cep);
CREATE INDEX IF NOT EXISTS idx_geocoding_cache_created_at ON geocoding_cache(created_at DESC);
CREATE INDEX IF NOT EXISTS idx_geocoding_cache_hits ON geocoding_cache(hits DESC);
